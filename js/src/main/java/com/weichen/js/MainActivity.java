...
//                wb.loadUrl("javascript:callJS()");
                ...
                wb.loadUrl("javascript:callJS('\"+传参+\"')");
            }
        });
...
//                });
                ...
                wb.evaluateJavascript("javascript:callJS('\"+传参+\"')", new ValueCallback<String>() {
                    @Override
                    public void onReceiveValue(String value) {
                        //此处为 js 返回的结果
                    }
    ...
    private void initWebView() {
        ...
        //参数1：Javascript对象名
        //参数2：Java对象名
        wb.addJavascriptInterface(new JstoAndroid(), "test");//AndroidtoJS类对象映射到js的test对象
